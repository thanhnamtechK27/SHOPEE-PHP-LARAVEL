            ...
            <div class="col-sm-9">
                <div class="table-responsive cart_info">
                    <table class="table table-condensed">
                        <thead>
                            <tr class="cart_menu" style="background-color: GREEN; border: 2px solid #ddd; color:white;">
                            ...
                            <tr>
                                ...
                                <td class="cart_total" style="padding: 10px; text-align: center;">
                                    ...
                                    <form action="{{ route('delete_product', $product->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button style="background: none; border: none; color: #007bff; margin-left:-5px;" type="submit" onclick="return confirm('Are you sure you want to delete this blog?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
                    ...
                    <a href="{{ route('add_product') }}">
                        <button style="background-color: GREEN;" class="btn btn-success" type="button">Add Product</button>
                    </a>
                </div>
            </div>
        </div>
