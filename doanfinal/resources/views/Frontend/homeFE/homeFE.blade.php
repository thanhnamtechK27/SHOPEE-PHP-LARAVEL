        ...
        <div class="row">
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    <H2 class="title text-center" style="color:#FE980F;">           </H2>
                    @if(session('error'))
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        ...
                                        @if ($product->hinhanh)
                                            <img src="{{ asset('upload/product/' . json_decode($product->hinhanh)[0]) }}" alt="{{ $product->name }}" style="width: 200px; height: auto; object-fit: cover;" />
                                        @else
                                            <img src="{{ asset('upload/product/default.jpg') }}" alt="{{ $product->name }}" style="width: 200px; height: auto; object-fit: cover;" />
                                        @endif
                                            <h2>{{ $product->price }}</h2>
                                            <p>{{ $product->name }}</p>
