                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12">Country ID</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control form-control-line" name="id_country" value="{{ $user->id_country }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="address">
                                            <option value="London" {{ $user->country == 'London' ? 'selected' : '' }}>London</option>
