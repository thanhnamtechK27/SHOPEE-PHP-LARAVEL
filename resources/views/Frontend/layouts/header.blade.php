					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{ route('home_fe') }}" class="active">Home</a></li>
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							<form action="{{ route('search') }}" method="GET">
								...
								<button style="  border-radius: 20px; background-color:green; padding: 5px; color:#fff;" type="submit">Tìm kiếm</button>
							</form>
						</div>
					</div>
				</div>
