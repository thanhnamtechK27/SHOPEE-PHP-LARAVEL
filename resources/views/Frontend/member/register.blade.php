		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				<div class="login-form" style="margin-left: -210px;margin-top: -10px; background-color: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
					<h2 style="text-align: center; margin-bottom: 20px; color: #FE980F;font-weight: bold;">REGISTER</h2>
					<form action="{{ route('register_fe') }}" method="POST" enctype="multipart/form-data">
						...
						<button type="submit" style="width: 100%; padding: 10px; border-radius: 4px; background-color: #007bff; color: #fff; border: none; font-size: 16px; margin-top: 10px;">Register</button>
					</form>
				</div><!--/login form-->
			</div>
		</div>
